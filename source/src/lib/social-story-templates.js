...
const GENERAL_STORIES = ["losing-game", "waiting-turn", "not-getting-want", "personal-space"];
...
export function createTemplateStory(templateId, childName, gender = "girl", kindergartenRest = "sleep", illustrationStyle = "new", language = "he") {
  ...
  const templates = {
    ...
    "losing-game": { title: "לפעמים מפסידים במשחק", pages: [["במשחק יש כללים, תורות ותוצאה. לפעמים ילד אחד מנצח וילד אחר מפסיד.", "🎲"], ["הפסד יכול לעורר אכזבה, כעס או עצב. אלה רגשות טבעיים, ולכל אחד הם מרגישים קצת אחרת.", "😔"], ["כשהרגש חזק, אפשר לעצור לרגע, לנשום ולתת לגוף זמן להירגע.", "🌬️"], ["גם כשמאוכזבים, אפשר להשאיר את המשחק והחלקים במקומם ולשמור על הגוף של כולם.", "🧩"], ["אפשר לומר: ‘אני מאוכזב/ת שהפסדתי’, לבקש הפסקה קצרה או להציע משחק נוסף.", "💬"], ["אפשר לפרגן למי שניצח. הפסד הוא חלק ממשחק, ועם הזמן אפשר ללמוד להתמודד איתו.", "🤝"]] },
    "waiting-turn": { title: "מחכים לתור", pages: [["לפעמים כמה ילדים רוצים להשתמש באותו משחק או מתקן. כשמישהו כבר משתמש בו, האחרים מחכים לתורם.", "⏳"], ["המתנה יכולה להיות קשה. אפשר להרגיש חוסר סבלנות, התרגשות או חשש שהתור לא יגיע.", "🙂"], ["אפשר לבדוק מי בתור עכשיו ומי אחריו. סימן, רשימה או מבוגר יכולים לעזור להבין את הסדר.", "👀"], ["בזמן ההמתנה שומרים מרחק בטוח ומשאירים מקום לילד שמשתמש במתקן.", "↔️"], ["אפשר להסתכל, לנשום, לספור בשקט או לבחור משהו קטן לעשות עד שהתור מתפנה.", "🌬️"], ["כשהילד שלפנינו מסיים, התור מתקדם. עכשיו אפשר להשתמש במתקן, ואחר כך לפנות אותו לילד הבא.", "🛝"]] },
    "not-getting-want": { title: "כשלא מקבלים את מה שרוצים", pages: [["לפעמים רוצים מאוד חפץ, פעילות או תשובה מסוימת, אבל אי אפשר לקבל אותם באותו רגע.", "💭"], ["כששומעים ‘לא’ או ‘לא עכשיו’, אפשר להרגיש אכזבה, עצב או כעס. הרגש אמיתי גם כשהתשובה נשארת כפי שהיא.", "😞"], ["כשהאכזבה גדולה, הגוף עשוי להיות מתוח או חסר שקט. עצירה ונשימה יכולות לתת לרגש מעט מקום.", "🌬️"], ["אפשר לספר מה רצינו ומה אנחנו מרגישים: ‘רציתי את זה, ואני מאוכזב/ת’.", "💬"], ["לפעמים אפשר לברר אם הדבר יתאפשר בזמן אחר. לפעמים אפשר לבחור בין שתי אפשרויות אחרות.", "🔄"], ["בחירה אחרת אינה מוחקת את האכזבה, אבל היא יכולה לעזור להמשיך הלאה עד שהרגש נחלש.", "🧸"]] },
  ...
  const englishTemplates = {
    ...
    kindergarten: { title: `${name === "אני" ? "I Am" : name + " Is"} Starting a New Preschool`, pages: [
      ...
      ["In the morning, I will arrive with Mom or Dad.", "👋"], ["If I miss home, I can look at a photo, cuddle a toy, or ask a teacher for help.", "😌"],
      ...
      ["At the end of the day, Mom or Dad will pick me up and I will go home.", "🏠"],
    ]},
    ...
    "losing-game": { title: "Sometimes We Lose a Game", pages: [["Games have rules, turns, and an outcome. Sometimes one child wins and another child loses.", "🎲"], ["Losing can bring disappointment, anger, or sadness. These feelings are natural and can feel different for everyone.", "😔"], ["When a feeling is strong, it can help to pause, breathe, and give the body time to settle.", "🌬️"], ["Even when disappointed, the game pieces can stay in place and everyone's body can stay safe.", "🧩"], ["A child can say, ‘I feel disappointed that I lost,’ ask for a short break, or suggest another game.", "💬"], ["It is possible to congratulate the winner. Losing is part of playing, and coping with it can become easier with practice.", "🤝"]] },
    "waiting-turn": { title: "Waiting for a Turn", pages: [["Sometimes several children want the same game or piece of equipment. When someone is using it, the others wait for their turn.", "⏳"], ["Waiting can be difficult. A child may feel impatient, excited, or worried that the turn will not come.", "🙂"], ["It can help to check whose turn it is and who comes next. A visual sign, list, or adult can make the order clear.", "👀"], ["While waiting, children keep a safe distance and leave room for the child using the equipment.", "↔️"], ["A child can watch, breathe, count quietly, or choose a small activity until the turn is free.", "🌬️"], ["When the child ahead finishes, the turn moves forward. After using it, the equipment becomes available for the next child.", "🛝"]] },
    "not-getting-want": { title: "When We Do Not Get What We Want", pages: [["Sometimes a child really wants an object, activity, or particular answer, but cannot have it at that moment.", "💭"], ["Hearing ‘no’ or ‘not now’ can bring disappointment, sadness, or anger. The feeling is real even when the answer stays the same.", "😞"], ["When disappointment is big, the body may feel tense or restless. Pausing and breathing can make room for the feeling.", "🌬️"], ["A child can explain what they wanted and how they feel: ‘I wanted that, and I feel disappointed.’", "💬"], ["Sometimes it is possible to ask about another time. Sometimes there are two different choices available now.", "🔄"], ["Another choice does not erase disappointment, but it can help a child continue until the feeling becomes smaller.", "🧸"]] },
    "personal-space": { title: "Respecting Personal Space", pages: [["Every person has personal space around their body. It is the distance that feels comfortable and safe near other people.", "↔️"], ["The space that suits one person may not suit another. It can change with the place, activity, and relationship.", "👫"], ["A face turning away, a body stepping back, an open hand, or the words ‘no’ and ‘stop’ can mean that more space is needed.", "✋"], ["When someone notices such a sign, they can pause and step back. This gives space and shows that they listened.", "👣"], ["Before a hug, touch, or taking a personal object, it is helpful to ask. The other person may agree or choose not to.", "❓"], ["People can choose another way to connect, such as waving, a high-five, or playing side by side. Personal space helps everyone feel safe.", "🙌"]] },
  };
  ...
  const general = GENERAL_STORIES.includes(templateId);
  const pages = story.pages.map(([text, emoji], index) => {
    ...
    return [
      language === "en" ? text : genderize(text, gender),
      emoji,
      illustration,
      schoolFront ? ["child"] : [],
      schoolFront ? `school-front-${gender}` : null,
      schoolFront ? schoolFrontBase : null,
    ];
  });
  const isNew = illustrationStyle === "new";
  return {
    ...story,
    illustrationStyle,
    ...
    coverFaceLayout: !isNew ? null
      : templateId === "kindergarten" ? `kindergarten-cover-${gender}`
      : templateId === "toilet" && gender === "girl" ? "toilet-cover-girl"
      : templateId === "school" ? `school-front-${gender}`
