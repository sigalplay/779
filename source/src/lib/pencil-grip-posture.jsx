...
const POSTURE_POINTS = [
  {
    ...
    titleEn: "Feet rest on a stable surface",
    explanation: "רגליים באוויר גורמות לחוסר שקט מוטורי ולחוסר יציבות של האגן.",
    explanationEn: "Supported feet help the pelvis stay stable and reduce unnecessary movement.",
  ...
  },
  {
    ...
    explanationEn: "Aim for roughly 90-degree bends at the hips and knees.",
    image: "/icon-bank/guidance/posture/2-pelvis.webp",
  },
  {
    title: "גב ישר ונתמך",
    titleEn: "Keep the back upright and supported",
    explanation: "כדי למנוע עייפות של שרירי הליבה.",
    explanationEn: "Support helps reduce fatigue in the core muscles.",
    image: "/icon-bank/guidance/posture/3-back.webp",
  },
  {
    title: "אמות ומרפקים נחים על השולחן",
    titleEn: "Forearms and elbows rest on the table",
    explanation: "תמיכה זו מאפשרת לשרירים העדינים של כף היד והאצבעות לפעול בדיוק מרבי.",
    explanationEn: "This support helps the hand and finger muscles work with greater control.",
  ...
  },
  {
    ...
    explanationEn: "This supports bilateral coordination and steadies the upper body.",
    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
        {POSTURE_POINTS.map((p, i) => {
          ...
          const explanation = language === "en" ? p.explanationEn : p.explanation;
          return (
            <div
              key={i}
            ...
            >
              <div className="relative flex h-40 w-full items-center justify-center overflow-hidden bg-white">
                ...
                <button
                  ...
                  aria-label={language === "en" ? "Show explanation" : "הצג הסבר"}
