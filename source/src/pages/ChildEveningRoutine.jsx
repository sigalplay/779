...
export default function ChildEveningRoutine() {
  ...
  return <div className="min-h-screen bg-cream" dir="rtl"><div className="mx-auto max-w-md px-4 py-8">
    ...
    <a href="/" className="mt-8 block rounded-2xl border border-rose/30 bg-rose/20 px-4 py-3 text-center font-bold text-foreground transition hover:bg-rose/30">צור לוח משלך — בואו נשחק</a>
  </div></div>;
}
