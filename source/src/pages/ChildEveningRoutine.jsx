...
export default function ChildEveningRoutine() {
  ...
  return <div className="min-h-screen bg-cream" dir="rtl"><div className="mx-auto max-w-md px-4 py-8">
    ...
    <a href={language === "en" ? "/en/" : "/"} className="mt-8 block rounded-2xl border border-rose/30 bg-rose/20 px-4 py-3 text-center font-bold text-foreground transition hover:bg-rose/30">{t("צור לוח משלך — בואו נשחק", "Create your own visual schedule — Let's Play")}</a>
  </div></div>;
}
