(function () {
  ...
  const translations = {
    ...
    ,"ממלאים שקית זיפלוק, מוציאים ממנה ככל האפשר את האוויר. ממלאים בחומר הרצוי. מחזקים את הפתח עם סלוטייפ ומדביקים לרצפה.": "Fill a zip-top bag and remove as much air as possible. Add the chosen material. Reinforce the opening with wide tape and secure the bag to the floor."
    ...
    ,"בטיחות:": "Safety:"
    ,"שקית הצבע": "Paint Bag"
    ,"פעילות חושית שבה הפעוט מורח ומערבב צבעי גואש דרך שקית זיפלוק סגורה.": "A sensory activity in which the baby spreads and mixes gouache paint through a sealed zip-top bag."
    ,"שקית זיפלוק": "Zip-top Bag"
    ,"צבעי גואש": "Gouache Paints"
    ,"מסקנטייפ": "Masking Tape"
    ,"מפזרים מספר נקודות גואש על הדף.": "Place several dots of gouache paint on the paper."
    ,"מכניסים בזהירות לתוך שקית זיפלוק ואוטמים עם סלוטייפ.": "Carefully place the paper inside a zip-top bag and seal it with tape."
    ,"נותנים לפעוט ליהנות מהמריחה של הצבעים.": "Let the baby enjoy spreading and mixing the colours."
    ,"הפעילות מתקיימת בהשגחת מבוגר בלבד. מוודאים שהשקית אטומה ושלמה לפני כל שימוש ולא מאפשרים לפעוט להכניס אותה לפה.": "Adult supervision is required. Make sure the bag is sealed and undamaged before every use, and do not let the baby put it in their mouth."
    ,"שקית צבע": "Paint bag"
    ,"גואש": "Gouache"
    ,"משוך במטפחת": "Pull the Scarf"
    ,"פעילות חושית לפעוטות שבה מושכים מטפחות קלות וצבעוניות מתוך גלילי קרטון.": "A sensory activity for babies who pull light, colourful scarves through cardboard tubes."
    ,"5 גלילי קרטון": "5 Cardboard Tubes"
    ,"5 מטפחות בד קלות וצבעוניות": "5 Light, Colourful Scarves"
    ,"מסקנטייפ רחב": "Wide Masking Tape"
    ,"בוחרים קיר פנוי ונקי וממקמים את הגלילים בגובה שנוח לפעוט להגיע אליו בישיבה.": "Choose a clear, clean wall and place the tubes where the baby can reach them while sitting."
    ,"מדביקים חמישה גלילי קרטון בשורה על הקיר בעזרת מסקנטייפ רחב.": "Secure five cardboard tubes in a row on the wall with wide masking tape."
    ,"משחילים בכל גליל מטפחת בד קצרה בצבע אחר ומשאירים קצה נגיש למשיכה.": "Thread a short scarf of a different colour through each tube and leave an end within reach."
    ,"מושיבים את הפעוט מול הגלילים ומאפשרים לו לבחור, לאחוז ולמשוך את המטפחות.": "Sit the baby in front of the tubes and let them choose, grasp and pull the scarves."
    ,"אפשר להתחיל בשניים או בשלושה גלילים בלבד ולהניח את קצות המטפחות קרוב לידיו של הפעוט.": "Start with only two or three tubes and place the scarf ends close to the baby's hands."
    ,"אפשר לומר יחד את שמות הצבעים, להחליף את סדר המטפחות או להחביא חלק קטן מכל מטפחת בתוך הגליל.": "Name the colours together, change the scarf order, or hide more of each scarf inside its tube."
    ,"הפעילות מתקיימת בהשגחת מבוגר צמודה. משתמשים במטפחות קצרות בלבד, מוודאים שהגלילים מחוברים היטב ולא מאפשרים כריכה של בד סביב הצוואר.": "Close adult supervision is required. Use only short scarves, make sure the tubes are firmly attached, and never allow fabric to wrap around the neck."
    ,"הושטת יד": "Reaching"
    ,"מטפחות": "Scarves"
    ,"משיכה": "Pulling"
