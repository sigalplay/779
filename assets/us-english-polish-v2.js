(() => {
  ...
  const exact = new Map([
    ...
    ["No activities have been added yet. Select Add to Treatment Plan to begin.", "No activities yet. Add an activity to start building your session."],
    ...
    ["Build a structured session board", "Build a Structured Session Plan"],
    ...
    ["Daily Routine Board Builder", "Daily Visual Schedule Builder"],
    ["Daily Routine Board", "Daily Visual Schedule"],
    ["Morning Routine Board", "Morning Visual Schedule"],
    ["Evening Routine Board", "Evening Visual Schedule"],
  ...
  function isEnglish() {
    try {
      return localStorage.getItem("boo_nesahek_language") === "en" || document.documentElement.lang === "en";
    } catch (_) {
