    ...
    <AppShell mode="parent">
      <div className="mx-auto max-w-5xl py-2">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="animate-in fade-in slide-in-from-bottom-2 duration-300"><IllustratedNavCard eager to="/therapist/build" image="/icon-bank/navigation-v2/therapy-build-flat.webp" title={t("מטפלים", "Therapists")} subtitle={t("בנה לוח למפגש טיפולי", "Build a Therapy Session Board")} description={t("בחרו גיל, מטרות וזמן ותכננו מפגש מותאם", "Choose the child's age, goals, and available time to plan a suitable session.")} large showArrow captionClassName={pinkCaption} className="h-full !min-h-[270px] md:!min-h-[290px]" /></div>
          <div className="animate-in fade-in slide-in-from-bottom-2 duration-300"><IllustratedNavCard eager to="/parent/play" image="/icon-bank/navigation-v2/play-today-flat.webp" title={t("הורים", "Parents")} subtitle={t("במה נשחק היום?", "What Shall We Play Today?")} description={t("בחרו גיל, קושי וזמן ונמצא רעיון מתאים", "Choose your child's age, needs, and available time to find a suitable activity.")} large showArrow captionClassName={pinkCaption} className="h-full !min-h-[270px] md:!min-h-[290px]" /></div>
        </div>
