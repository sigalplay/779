...
export const DAILY_SEQUENCE_TEMPLATES = [
  ...
  { id: "dressing", category: "clothing", hidden: true, title: "סדר פעולות לבוש", description: "לבישת הבגדים לפי סדר", cover: daily("dressing", "done") },
  { id: "buttoning", category: "clothing", hidden: true, genderNeutral: true, title: "מכפתרים כפתורים", description: "רצף חזותי קצר וברור לרכיסת כפתור", cover: daily("buttoning", "find") },
];

export const DAILY_SEQUENCE_CATEGORIES = [
  { id: "clothing", hidden: true, title: "לבוש", description: "רצפים חזותיים לעצמאות בלבוש", cover: daily("buttoning", "find") },
];
...
export function stepsForDailySequence(templateId, gender = "girl") {
  const steps = {
    ...
    buttoning: [
      ["button-find", "מוצאים את הכפתור ואת הלולאה שמולו", daily("buttoning", "find")],
      ["button-hold", "מחזיקים את הכפתור ביד אחת", daily("buttoning", "hold-button")],
      ["button-hold-hole", "מחזיקים את הלולאה ביד השנייה", daily("buttoning", "hold-buttonhole")],
      ["button-insert", "מכניסים את קצה הכפתור ללולאה", daily("buttoning", "insert")],
      ["button-push-pull", "דוחפים את הכפתור פנימה ומושכים אותו מהצד השני", daily("buttoning", "push-pull")],
    ],
  };
