...
const PUBLIC_PAGE_META = {
  ...
  "/privacy": ["מדיניות פרטיות — בואו נשחק", "מידע על איסוף, שימוש ושמירה של מידע באתר בואו נשחק."],
  "/terms": ["תנאי שימוש — בואו נשחק", "תנאי השימוש באתר בואו נשחק להורים, למטפלים ולמשתמשים."],
  "/cookies": ["מדיניות Cookies — בואו נשחק", "מידע על Cookies, אחסון מקומי ומדידת שימוש באתר בואו נשחק."],
};
...
const PUBLIC_PAGE_META_EN = {
  ...
  "/privacy": ["Privacy Policy — Let's Play", "How Let's Play collects, uses and protects information."],
  "/terms": ["Terms of Use — Let's Play", "Terms for parents, therapists and other users of the Let's Play website."],
  "/cookies": ["Cookie Policy — Let's Play", "Information about Cookies, local storage and analytics on Let's Play."],
};
